<%@ Page Title="" Language="C#" MasterPageFile="~/ResultProcessing.master" AutoEventWireup="true" CodeFile="SmsSettings.aspx.cs" Inherits="SmsSettings" %>
                ...
                <div class="card-body">
                    <asp:Panel ID="PnlSms" runat="server">
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">SMS Name</label>
                            <div class="col-sm-12 col-md-7">
                                <asp:TextBox ID="sms_name" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Authentication ID</label>
                            <div class="col-sm-12 col-md-7">
                                <asp:TextBox ID="auth_id" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
