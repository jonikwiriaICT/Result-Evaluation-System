<%@ Page Title="" Language="C#" MasterPageFile="~/ResultProcessing.master" AutoEventWireup="true" CodeFile="ViceChancellor.aspx.cs" Inherits="ViceChancellor" %>
    ...
    <div class="row" runat="server" id="formTemplate">
        <div class="col-12 col-sm-12 col-lg-12">
            <div class="card ">
                ...
                <div class="card-body">
                    <asp:Panel ID="PnlVice" runat="server">
                        <asp:HiddenField ID="rec_id" runat="server" />
                           <asp:HiddenField ID="vice_signature" runat="server" />
