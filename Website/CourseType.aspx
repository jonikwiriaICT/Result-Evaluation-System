<%@ Page Title="" Language="C#" MasterPageFile="~/ResultProcessing.master" AutoEventWireup="true" CodeFile="CourseType.aspx.cs" Inherits="CourseType" %>
                ...
                <div class="card-body">
                    <asp:Panel ID="PnlCourseType" runat="server">
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Level Name</label>
                            <div class="col-sm-12 col-md-7">
                                <asp:TextBox ID="type_ref" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        <asp:LinkButton ID="lnkInsertClicked" OnClick="ExcelInsertClicked" runat="server"><i class="fas fa-upload text-success "></i></asp:LinkButton>
