<%@ Page Title="" Language="C#" MasterPageFile="~/ResultProcessing.master" AutoEventWireup="true" CodeFile="ExamOfficer.aspx.cs" Inherits="ExamOfficer" %>
    ...
    <div class="row" runat="server" id="formTemplate">
        <div class="col-12 col-sm-12 col-lg-12">
            <div class="card ">
                ...
                <div class="card-body">
                    <asp:Panel ID="PnlExamOfficer" runat="server">
                        <asp:HiddenField ID="rec_id" runat="server" />
                        <asp:HiddenField ID="officer_signature" runat="server" />

                        <asp:HiddenField ID="department_description" runat="server" />
                        <div class="form-group row mb-4 overflow-auto ">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Staff Name</label>
                            <div class="col-sm-12 col-md-7">
                                <asp:DropDownList ID="staff_id" CssClass=" form-control select2" runat="server"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Staff Signature</label>
                            <div class="col-sm-12 col-md-7">
                        ...
                        <div class="form-group row mb-4 overflow-auto ">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <asp:DropDownList ID="active" CssClass=" form-control select2" runat="server">
