<%@ Page Title="" Language="C#" MasterPageFile="~/ResultProcessing.master" AutoEventWireup="true" CodeFile="Department.aspx.cs" Inherits="Department" ValidateRequest="false" %>
                ...
                <div class="card-body">
                    <asp:Panel ID="PnlDepartment" runat="server">
                        <asp:HiddenField ID="rec_id" runat="server" />
                         <asp:HiddenField ID="faculty_id" runat="server" />
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Department Code</label>
                            <div class="col-sm-12 col-md-7">
                                <asp:TextBox ID="department_code" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Department Description</label>
                            <div class="col-sm-12 col-md-7">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlFaculty" CssClass="form-control select2" AutoPostBack ="true" OnSelectedIndexChanged ="FacultySearchClicked" runat="server">
                                </asp:DropDownList>
