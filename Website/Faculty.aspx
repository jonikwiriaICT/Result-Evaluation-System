<%@ Page Title="" Language="C#" MasterPageFile="~/ResultProcessing.master" AutoEventWireup="true" CodeFile="Faculty.aspx.cs" Inherits="Faculty" ValidateRequest ="false" %>
            ...
            <div class="card ">
                ...
                <div class="card-body">
                    <asp:Panel ID="PnlFaculty" runat="server">
                        ...
                        <asp:HiddenField ID="faculty_description" runat="server" />
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Faculty Name</label>
                            <div class="col-sm-12 col-md-7">
                                <asp:TextBox ID="faculty_name" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Faculty Code</label>
                            <div class="col-sm-12 col-md-7">
                                <asp:TextBox ID="faculty_code" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Faculty Description</label>
                            <div class="col-sm-12 col-md-7">
