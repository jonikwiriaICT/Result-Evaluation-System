...
public partial class Doctors_DoctorMaster : System.Web.UI.MasterPage
{
    ...
    public string Lecturer
    {
        get
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(sValue) == true)
                {
                    sValue = Session["lecturer"].ToString();
                }
                return sValue;
            }
            catch (Exception ex)
            {
                try
                {
                    return Session["lecturer"].ToString();
                }
                catch (Exception ex2) { }
                return string.Empty;
            }
