<%@ Page Title="" Language="C#" MasterPageFile="~/StaffFolder/StaffMaster.master" AutoEventWireup="true" CodeFile="HODApproval.aspx.cs" Inherits="StaffFolder_HODApproval" ValidateRequest ="false"  %>
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="TableResult" CssClass="table table-striped table-bordered c  table-hover weather-table" Font-Size="10px" BorderColor="Transparent" runat="server" AutoGenerateColumns="false" OnRowCommand="TableCommand" OnRowDataBound="OnRowDataBound"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-Width="15%" HeaderText="Submit Result" Visible="true" HeaderStyle-CssClass=" thead-default" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderStyle-Width="7%" HeaderText="Result Analysis" Visible="true" HeaderStyle-CssClass=" thead-default" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderStyle-Width="5%" HeaderText="Remark" FooterStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
