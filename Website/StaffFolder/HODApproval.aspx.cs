...
public partial class StaffFolder_HODApproval : System.Web.UI.Page
{
    ...
    public string Lecturer()
    {
        try
        {
            string lecturer = ((Doctors_DoctorMaster)this.Master).HOD;
            return lecturer;
        }
        catch (Exception ex)
        {
    ...
    protected void OnRowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        for (int i = 0; i < TableResult.Rows.Count; i++)
        {
            ...
            if (hdResult.Value.Equals("confirmed") || hdResult.Value.Equals("rejected"))
            {
                ...
                submitResult.Text = "No Result to submit";
            }
            else
            {
                ...
                submitResult.Text = "Submit Result";
            }
            ...
            else if (lblRemark.Text.Contains("Waiting"))
            {
                ...
                submitResult.Text = "Result submitted";
