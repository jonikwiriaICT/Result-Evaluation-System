<%@ Page Title="" Language="C#" MasterPageFile="~/ResultProcessing.master" AutoEventWireup="true" CodeFile="Level.aspx.cs" Inherits="Level" %>
                    ...
                    <asp:Panel ID="PnlLevel" runat="server">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <asp:TextBox ID="level_name" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
