<%@ Page Title="" Language="C#" MasterPageFile="~/ResultProcessing.master" AutoEventWireup="true" CodeFile="CourseRegistration.aspx.cs" Inherits="CourseRegistration" ValidateRequest ="false"  %>
    ...
    <div class="row" runat="server" id="View">
        <div class="col-12 col-sm-12 col-lg-12">
            <div class="card ">
                ...
                <div class="card-body">
                    <asp:Panel ID="PnlCourseRegistration" runat="server">
                        ...
                        <div class="col-md-4" runat ="server"  >
                            <label>Matric Number</label>
                             <div class="input-group">
                                <asp:DropDownList ID="matric_no" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="selectCoursed" runat="server">
                                </asp:DropDownList>
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        <asp:LinkButton ID="lnksaveChangesClikced" CssClass ="btn btn-sm btn-outline-success " OnClick="SaveChangesClicked"  runat="server"><i class="fas fa-save "></i>&nbsp Save Changes</asp:LinkButton>
