<%@ Page Title="" Language="C#" MasterPageFile="~/ResultProcessing.master" AutoEventWireup="true" CodeFile="DeanOfFaculty.aspx.cs" Inherits="DeanOfFaculty" %>
            ...
            <div class="card ">
                ...
                <div class="card-body">
                    <asp:Panel ID="PnlDean" runat="server">
                        ...
                        <asp:HiddenField ID="dean_signature" runat="server" />
