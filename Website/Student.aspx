<%@ Page Title="" Language="C#" MasterPageFile="~/ResultProcessing.master" AutoEventWireup="true" CodeFile="Student.aspx.cs" Inherits="Student" ValidateRequest="false" %>
                ...
                <div class="card-body">
                    <asp:Panel ID="PnlStudent" runat="server">
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Matric Number</label>
                            <div class="col-sm-12 col-md-7">
                                <asp:TextBox ID="mt_id" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                        ...
                        <div class="form-group row mb-4" runat ="server" visible ="false" >
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Telephone Number</label>
                            <div class="col-sm-12 col-md-7">
                                <asp:TextBox ID="telephone_no" CssClass="form-control decimal" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Marital Status</label>
                            <div class="col-sm-12 col-md-7">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <button class="btn btn-success  pull-right" id="btndep" runat="server" onserverclick="SaveChangesClicked"><i class="fa fa-save"></i>&nbsp  Save Changes</button>
                            </div>
                        </div>
                    </asp:Panel>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Select by Program</label>
                                <asp:DropDownList ID="ddlprogram" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="SelectProgramClicked" runat="server">
                                </asp:DropDownList>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlLevel" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="SelectLevelClicked" runat="server">
                                </asp:DropDownList>
                            ...
                            <div class="input-group">
                                ...
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        <asp:LinkButton ID="lnkUpload" OnClick="ExcelInsertClicked" runat="server"><i class="fas fa-upload text-success "></i></asp:LinkButton>
