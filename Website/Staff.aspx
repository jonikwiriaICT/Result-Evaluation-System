<%@ Page Title="" Language="C#" MasterPageFile="~/ResultProcessing.master" AutoEventWireup="true" CodeFile="Staff.aspx.cs" Inherits="Staff" ValidateRequest ="false"  %>
            ...
            <div class="card ">
                ...
                <div class="card-body">
                    <asp:Panel ID="PnlStaff" runat="server">
                        ...
                        <asp:HiddenField ID="staff_description" runat="server" />
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Staff ID</label>
                            <div class="col-sm-12 col-md-7">
                                <asp:TextBox ID="st_id" CssClass="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Staff Description</label>
                            <div class="col-sm-12 col-md-7">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlDepartment" CssClass="form-control select2" AutoPostBack ="true" OnSelectedIndexChanged ="FacultySearchClicked" runat="server">
                                </asp:DropDownList>
