<%@ Page Title="" Language="C#" MasterPageFile="~/ResultProcessing.master" AutoEventWireup="true" CodeFile="Semester.aspx.cs" Inherits="Semester" %>
                ...
                <div class="card-body">
                    <asp:Panel ID="PnlSemester" runat="server">
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Semester Name</label>
                            <div class="col-sm-12 col-md-7">
                                <asp:TextBox ID="semester_name" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
