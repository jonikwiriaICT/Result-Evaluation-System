<%@ Page Title="" Language="C#" MasterPageFile="~/ResultProcessing.master" AutoEventWireup="true" CodeFile="AssignCourse.aspx.cs" Inherits="AssignCourse" ValidateRequest="false" %>
    ...
    <div class="row" runat="server" id="View">
        <div class="col-12 col-sm-12 col-lg-12">
            <div class="card ">
                ...
                <div class="card-body">
                    <asp:Panel ID="PnlAssignCourses" runat="server">
                        <asp:HiddenField ID="rec_id" runat="server" />
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Select by Staff</label>
                                <asp:DropDownList ID="staff_id" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="selectStaff" runat="server">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="course_id" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="selectCourse" runat="server">
                                </asp:DropDownList>
                        ...
                        <div class="col-md-4">
                              ...
                              <label>Select by Session</label>
                             <div class="input-group">
                              <asp:DropDownList ID="session_id" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="selectSession" runat="server">
                                </asp:DropDownList>

                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        <asp:LinkButton ID="lnkSaveChanges" OnClick="SaveChangesClicked" CssClass ="btn btn-sm btn-outline-success" runat="server"><i class="fas fa-save "></i> &nbsp Save Changes</asp:LinkButton>
