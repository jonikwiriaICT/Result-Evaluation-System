<%@ Page Title="" Language="C#" MasterPageFile="~/ResultProcessing.master" AutoEventWireup="true" CodeFile="HeadOfDepartment.aspx.cs" Inherits="HeadOfDepartment" %>
    ...
    <div class="row" runat="server" id="formTemplate">
        <div class="col-12 col-sm-12 col-lg-12">
            <div class="card ">
                ...
                <div class="card-body">
                    <asp:Panel ID="PnlHod" runat="server">
                        <asp:HiddenField ID="rec_id" runat="server" />
                        <asp:HiddenField ID="hod_signature" runat="server" />
