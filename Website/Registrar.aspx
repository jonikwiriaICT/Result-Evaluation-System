<%@ Page Title="" Language="C#" MasterPageFile="~/ResultProcessing.master" AutoEventWireup="true" CodeFile="Registrar.aspx.cs" Inherits="Registrar" %>
            ...
            <div class="card ">
                ...
                <div class="card-body">
                    <asp:Panel ID="PnlRegistrar" runat="server">
                        ...
                        <asp:HiddenField ID="registrar_signature" runat="server" />
